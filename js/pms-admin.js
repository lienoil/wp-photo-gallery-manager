jQuery(document).ready(function($) {
    ...
    // Carousel
    $(document).on('click', '.button-media-wps', function (e) {
        e.preventDefault();
        ...
        $_item.append(
            '<div id="carousel_item_'+$key+'" class="carousel-item">'
                + '<div class="input-group">'
                    + '<button data-target="#carousel_item_'+$key+'" type="button" class="pull-right button-destroy carousel button button-default button-large"><i class="dashicons-before dashicons-no-alt fa fa-times"></i></button>'
                + '</div>'
                + '<img id="pms_photos_image_'+$key+'" role="button" class="button-media-wps" data-target="#pms_photos_image_'+$key+'" data-input="#pms_photos_image_input_'+$key+'" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="300" height="225">'
